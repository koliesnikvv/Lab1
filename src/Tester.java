...
//        university.addStudent("Юрій", "Остапенко", "Анатолійович", 0, 4, 3);
    ...
    private static void departmentSort(University university) {
        ...
        switch (chooseForDep){
            case 1 -> {
                String dep = university.getSortedDepartmentStudentsByYear(0);
...
//            case 3 -> ;
//            case 4 -> ;
          //  case 5 -> Sorter.sortingStudentsByFullName();
//            case 6 -> ;
//            case 7 -> ;
//            case 8 -> ;
//            case 9 -> ;
